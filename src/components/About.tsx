      ...
      <div className="relative mx-auto mt-20 max-w-lg">
        <div className="relative w-full rounded-lg bg-blue-100 p-4 ps-20 md:h-64 md:ps-48">
            ...
            <table className="mt-4 w-full text-sm">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a
                      href="mailto:email-test@email.com"
                      className="underline hover:text-blue-800"
                    >
          ...
          <div
            ...
            bg-gray-600
            bg-[url(https://images.unsplash.com/photo-1601455763557-db1bea8a9a5a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fGF2YXRhciUyMHBob3RvfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60)] 
